...
class Gaea(Resource):
    def __init__(self, name="GaeaResource", coap_server=None):
        super(Gaea, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Gaea. Gaea, or Mother Earth, was the great goddess of the early Greeks. " \
                       "She represented the Earth and was worshipped as the universal mother. In Greek mythology, " \
                       "she created the Universe and gave birth to both the first race of gods (the Titans) and the first humans"
...
class Hera(Resource):
    def __init__(self, name="HeraResource", coap_server=None):
        super(Hera, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Hera. "
        self.resource_type = "Myth.Gaea.Hear"
...
class Poseidon(Resource):
    def __init__(self, name="PoseidonResource", coap_server=None):
        super(Poseidon, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Poseidon. "
        self.resource_type = "Myth.Gaea.Poseidon"
...
class Demeter(Resource):
    def __init__(self, name="DemeterResource", coap_server=None):
        super(Demeter, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Demeter. "
        self.resource_type = "Myth.Gaea.Demeter"
...
class Hades(Resource):
    def __init__(self, name="HadesResource", coap_server=None):
        super(Hades, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Hades. "
        self.resource_type = "Myth.Gaea.Hades"
...
class Athena(Resource):
    def __init__(self, name="AthenaResource", coap_server=None):
        super(Athena, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Athena. "
        self.resource_type = "Myth.Gaea.Athena"
...
class Chaos(Resource):
    def __init__(self, name="ChaosResource", coap_server=None):
        super(Chaos, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Chaos. "
...
class Zeus(Resource):
    def __init__(self, name="ZeusResource", coap_server=None):
        super(Zeus, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Zeus. "
        self.resource_type = "Myth.Chaos.Zeus"
...
class Zeus1(Resource):
    def __init__(self, name="Zeus1Resource", coap_server=None):
        super(Zeus1, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Zeus10. "
        self.resource_type = "Myth.Chaos.Zeus"
...
class Zeus2(Resource):
    def __init__(self, name="Zeus2Resource", coap_server=None):
        super(Zeus2, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Zeus11. "
        self.resource_type = "Myth.Chaos.Zeus"
...
class Zeus3(Resource):
    def __init__(self, name="Zeus3Resource", coap_server=None):
        super(Zeus3, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
        self.payload = "Hello, I'm Zeus12. "
        self.resource_type = "Myth.Chaos.Zeus"
