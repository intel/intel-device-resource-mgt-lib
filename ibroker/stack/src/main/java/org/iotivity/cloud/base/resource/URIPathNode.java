...
public class URIPathNode {
  private ConcurrentHashMap<String, URIPathNode> mChildren = new ConcurrentHashMap<>();
  private IRequestEventHandler mRequestHandler = null;

  public URIPathNode addHandler(List<String> pathSegments, IRequestEventHandler requestHandler) {
  ...
  public IRequestEventHandler findPathHandler(List<String> pathSegments) {
    ...
    for (String pathSegment : pathSegments) {
      ...
      if (childNode == null) return edgeNode.mRequestHandler;
