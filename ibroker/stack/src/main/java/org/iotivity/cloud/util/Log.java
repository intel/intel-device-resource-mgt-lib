...
public class Log {
  ...
  public static void Init() throws FileNotFoundException {
    // System.setOut(Log.createLoggingProxy(System.out)); // enable this line will cause rd tests
    // hang
    // createfile();
  }
  ...
  public static void f(Channel channel, Throwable t) {
    String log = channel.id().asLongText().substring(26) + " " + t.getMessage();
    if (ps != null) {
