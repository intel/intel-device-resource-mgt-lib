...
public class MessageBuilder {
  ...
  public static IResponse createResponse(IRequest request, ResponseStatus responseStatus) {
    return createResponse(request, responseStatus, ContentFormat.NO_CONTENT, null);
  }

  public static IResponse createResponse(
      IRequest request, ResponseStatus responseStatus, ContentFormat format, byte[] payload) {
      ...
      if (coapRequest.getMethod() == RequestMethod.GET
        ...
        switch (coapRequest.getObserve()) {
          ...
          case SEQUENCE_NUMBER:
            coapResponse.setSequenceNumber(coapRequest.getNextSequenceNumber());
            break;
          default:
        }
      }
  ...
  public static IRequest createRequest(
      RequestMethod requestMethod, String uriPath, String uriQuery) {
    return createRequest(requestMethod, uriPath, uriQuery, ContentFormat.NO_CONTENT, null);
  }
  ...
  public static IRequest modifyRequest(
      IRequest orgRequest,
      String uriPath,
      String uriQuery,
      ContentFormat contentFormat,
  ...
  public static IResponse modifyResponse(
      IResponse orgResponse, ContentFormat contentFormat, byte[] payload) {

    return modifyResponse(orgResponse, null, contentFormat, payload);
  }

  public static IResponse modifyResponse(
      IResponse orgResponse, String uriPath, ContentFormat contentFormat, byte[] payload) {
