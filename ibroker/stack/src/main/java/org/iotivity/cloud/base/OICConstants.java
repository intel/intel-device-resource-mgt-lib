...
public class OICConstants {
  ...
  public static final String ACL_ID_FULL_URI =
      "/" + OICConstants.PREFIX_OIC + "/" + OICConstants.ACL_URI + "/" + OICConstants.ID_URI;

  public static final String ACL_VERIFY_FULL_URI =
      "/" + OICConstants.PREFIX_OIC + "/" + OICConstants.ACL_URI + "/" + OICConstants.VERIFY_URI;

  public static final String GROUP_FULL_URI =
      "/" + OICConstants.PREFIX_OIC + "/" + OICConstants.ACL_URI + "/" + OICConstants.GROUP_URI;

  public static final String INVITE_FULL_URI =
      "/" + OICConstants.PREFIX_OIC + "/" + OICConstants.ACL_URI + "/" + OICConstants.INVITE_URI;

  public static final String KEEP_ALIVE_FULL_URI =
      "/" + PREFIX_OIC + "/" + OICConstants.KEEP_ALIVE_URI;
  ...
  public static final String CREDPROV_CERT_FULL_URI =
      "/" + PREFIX_OIC + "/" + CREDPROV_URI + "/" + CERT_URI;
}
